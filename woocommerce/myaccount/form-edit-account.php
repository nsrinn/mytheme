...
<div class="container">
	<h1 class="mt-3 mb-2"> <b>Account Details</b> </h1>
    ...
    <fieldset>
        <h2><b><legend><?php esc_html_e('Change Password ', 'woocommerce'); ?></legend></b></h2>
    ...
    <div class="form-group">
        ...
        <button type="submit" class="btn btn-primary btn-account-details" name="save_account_details" value="<?php esc_attr_e('Save changes', 'woocommerce'); ?>"><?php esc_html_e('Save changes', 'woocommerce'); ?></button>
